...
namespace Advent_Of_Code_2018
{
    class Day20
    {
        ...
        {
            return Solver(input).dMax;
        }
        public static int PartTwo(string input)
        {
            return Solver(input).distantRooms;
        }
        public static (int dMax, int distantRooms) Solver(string input)
        {
        ...
        public static IEnumerable<((int x, int y) posFrom, (int x, int y) posTo)> Doors(string input)
        {
